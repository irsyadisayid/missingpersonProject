...
public class MissingPersonData implements Serializable {
    ...
    public MissingPersonData(String userId, String name, String age,String religion, String gender, String address, String missing_date, String prize, String contacts, ArrayList<String> photo_urls, String description) {
        this.userId = userId;
        this.name = name;
        this.age = age;
