...
import static com.example.daftarpencarianorang.Constants.Parameters.IMAGE_URL_TRANSFER_KEY;
...
import com.example.daftarpencarianorang.Activity.ImagePreviewActivity;
...
public class PhotoGridAdapter extends RecyclerView.Adapter<PhotoGridAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.grid_photo_layout, parent, false);
