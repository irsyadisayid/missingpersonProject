...
import com.example.daftarpencarianorang.Model.ImageDetailFile;
...
public class PhotoListAdapter extends RecyclerView.Adapter<PhotoListAdapter.MyViewHolder> {
    Context mContext;
    ArrayList<ImageDetailFile> mList;

    public PhotoListAdapter(Context context, ArrayList<ImageDetailFile> list) {
        mContext = context;
        mList = list;
    }
