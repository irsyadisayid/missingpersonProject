...
public class MyMissingPersonListAdapter extends RecyclerView.Adapter<MyMissingPersonListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        ).placeholder(R.drawable.ic_person)).load(mList.get(position).getPhoto_urls(
        ).get(0)).circleCrop().into(holder.mProfileImage);
...
//    }
    ...
    public interface MyMissingPersonListListener{
        public void onClick();
    }
}
